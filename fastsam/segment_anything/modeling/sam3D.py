...
class Sam3D(torch.nn.Module):
    ...
    def postprocess_masks(
        ...
        masks = torch.nn.functional.interpolate(masks, original_size, mode="bilinear", align_corners=False)
        return masks
    ...
    def preprocess(self, x: torch.Tensor) -> torch.Tensor:
        ...
        x = torch.nn.functional.pad(x, (0, padw, 0, padh, 0, padd))
        return x
